(() => {
  ...
  function drawBigHeart(cx, cy, hs, progress, fill, now) {
    ...
    glowGrad.addColorStop(0, 'rgba(167,139,250,.5)');
    glowGrad.addColorStop(.5, 'rgba(249,168,212,.5)');
    glowGrad.addColorStop(1, 'rgba(167,139,250,.5)');
